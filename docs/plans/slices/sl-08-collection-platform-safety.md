...
**Required Contract portions before development:** `platform-safety.md` — capacity/risk/block/restoration; `execution-runtime.md` — applicable access outcome evidence; `storage.md` — retained risk and diagnostic privacy; `evaluation-observability.md` — controlled shared-safety checks. Applicable common/storage scope from [global Plan 2](../implementation-plan.md#2-milestone-readiness-completion-and-dependency-meaning) also applies.
...
**Scope:** Frozen Preferences/search translation, two-stage transient candidate screening and complete BOSS admission, source observations/freshness, aggregate audit, stop/partial results and explicit refresh.
...
**Required upstream capability:** [SL-01.M2](sl-01-workspace-jobs-preferences.md#sl-01m2-hard-preferences-and-local-screening) — Jobs, hard Preferences and metadata screening; [SL-08.M1](#sl-08m1-shared-recruiting-platform-safety) — shared platform/account risk admission
...
**Required Contract portions before development:** `collection.md` — adapter/search/frozen input/refresh/stop/audit; `jobs-screening.md` — BOSS admission/observations; `platform-safety.md` — collection consumer agreement; `execution-runtime.md`, `storage.md` — actual platform effect/retention scope; `evaluation-observability.md` — controlled source fixtures and workflow evidence. Applicable common/storage scope from [global Plan 2](../implementation-plan.md#2-milestone-readiness-completion-and-dependency-meaning) also applies.

**Joint agreement:** Frozen remote collection uses its own intent while local views use current Preferences. Preserve full JobVersion meaning; risk and durable outcomes use existing owners.
